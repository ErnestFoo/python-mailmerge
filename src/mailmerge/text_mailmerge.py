...
class TextMailMerge(BaseMailMerge):
    ...
    def __init__(self,
        ...
        self.output_file_handler = output_file_handler or FileHandler(mode=FileHandlerMode.WRITE)
    ...
    def load_input_data(self, input_json: dict):
        ...
        self.input_processor.process_input_into_collection(input_json)
        return True
    ...
    def delete_zones(self):
        ...
        for zone in zones_to_delete:
            ...
            if count > 0:          
                print(f"Removed {count} occurrence(s) of zone: {zone.zone_name}")
                
        self._temp_buffer = content
    ...
    def __base_replace(self, zone: dict ):
        ...
        # Check if item_count is a key in zone_keys to determine if it's a list replacement
    ...
    def __is_zone_array(self, zone: dict) -> bool:
        ...
        return 'item_count' in zone.zone_keys and isinstance(zone.zone_keys['item_count'], int)
    ...
    def __key_replace(self, zone:dict):
        ...
        # For non-global zones, replace within the zone tags only
            ...
            #Finally, remove zone tags
            content = content.replace(start_tag, "").replace(end_tag, "")

            print(f"Replaced zone {zone.zone_name} in template.")
            print(f"Final content after replacing zone {zone.zone_name}:\n{content}")
...
if __name__ == "__main__":
    ...
    template ="/home/ernestfoo/Documents/python-mailmerge/Sample_Input/sample_contract.txt"
    ...
    mailmerge.save_output_from_buffer("output.txt")
